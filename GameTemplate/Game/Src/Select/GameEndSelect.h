...
namespace nsApp
{
	...
	public:/*列挙型。*/
		...
		{
			enSelectDirectionUIAnimationSprite_RetryTextUI,/*「リトライ」テキストUI。*/
			enSelectDirectionUIAnimationSprite_QuestSelectTextUI,/*「クエスト選択」テキストUI。*/
	...
	private:/*スプライトを表示するファイルパス用のメンバ変数。*/
		...
		std::string m_textUIFilePath = "Assets/sprite/inGame/text/decision.dds";/*テキストUIのファイルパス。*/
	};
}
