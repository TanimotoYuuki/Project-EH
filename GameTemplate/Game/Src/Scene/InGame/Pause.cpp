	...
	namespace nsGame
	{
		...
		void Pause::UpdateSelect()
		{
			...
			if (g_pad[0]->IsTrigger(enButtonUp))
			{
				...
				if (m_currentSelect == enSelect_ReturnToGame)
				{
					m_currentSelect = enSelect_ReturnToQuestSelect;
					return;
				}
			...
			if (g_pad[0]->IsTrigger(enButtonDown))
			{
				...
				if (m_currentSelect == enSelect_ReturnToQuestSelect)
				{
					m_currentSelect = enSelect_ReturnToGame;
					return;
				}
