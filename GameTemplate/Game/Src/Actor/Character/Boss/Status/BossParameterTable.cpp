...
namespace nsApp
{
    namespace nsAI
    {
        ...
        {
			/* TSV    personality   ̕       BossPersonality  ɕϊ  B  `    Ă  Ȃ       Ȃ  Balanced   Ԃ  B */
        ...
        {
			/* TSV    BossType   ̕       CharacterModelType  ɕϊ  B  `    Ă  Ȃ       Ȃ  false   Ԃ  B */
        ...
        {
			/* TSV  ̍s     BossTypeParameters  𐶐  B   ݂  Ȃ   ̓f t H   g l  g p B */
            BossTypeParameters p;

			/* BossType   ͌Ăяo     ŏ       Ă  邽 ߁A     ł  personality   ݂̂ ϊ    Đݒ肷  B */
        ...
        {
			/*  f t H   g l  ݒ BTSV  ǂݍ  ݂Ɏ  s     Ƃ   ATSV  ɒ `    Ă  Ȃ  { X ^ C v ̃p     [ ^  v     ꂽ Ƃ  Ɏg p     B */
